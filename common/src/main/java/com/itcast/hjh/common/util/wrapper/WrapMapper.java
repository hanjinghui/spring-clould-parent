package com.itcast.hjh.common.util.wrapper;

import com.itcast.hjh.common.core.mybatis.BaseEntity;
 ...
 */
public class WrapMapper<S extends BaseEntity> {
	...
	public static <E> Wrapper<E> wrap(Exception e) {
		return new Wrapper(com.itcast.hjh.common.util.wrapper.Wrapper.ERROR_CODE, e.getMessage());
	}
